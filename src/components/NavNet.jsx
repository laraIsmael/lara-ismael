    ...
    <>
      <div className="flex flex-col font-display px-12 pt-10 bg-sky-400">
        <div className="flex flex-row justify-between"> 
          ...
          <img src="./NavNet-img/navnet_header_page.webp" 
          className="w-3/5" alt="Navnet" />
        </div>
      </div>
      ...
      <div className="flex py-12 px-12 flex-row justify-left"> 
        ...
        <div className="flex flex-col p-6 self-left items-start">
          ...
          <p className="text-sky-800 text-md pb-2 font-light">
      ...
      <div className="flex flex-col font-display px-12 pt-10 bg-sky-900">
        ...
        <div className="flex flex-row items-center pb-5"> 
          <div className="flex flex-col items-left w-1/3">
            <p className="text-sky-50 text-xl font-light">
              The Problem
            </p>
            <p className="text-sky-100 text-lg pb-2 pr-2 font-light">
          ...
          <div className="flex flex-col items-left ml-6 pb-10 w-2/3">
            <p className="text-sky-50 text-md py-2 font-light">
              Background
            </p>
            <p className="text-sky-100 text-sm pb-2 pl-3 font-light">
              Navigator Networks is an IT Solutions Provider specializing in Network Security and Architectural Services for Enterprise Infrastructure.<br/>
            ...
            <p className="text-sky-100 text-sm pl-3 pb-2 font-light">
            ...
            <p className="text-sky-100 self-end text-sm pl-3 pr-2 font-light">
            ...
            <p className="text-sky-100 text-sm pb-2 pl-3 font-light">
              «» Customers: IT Managers of companies with 100-500 employees <br/><br/>
        ...
        <div className="flex flex-col items-center py-5"> 
          <div className="flex flex-row items-left pb-10 w-full">
              <p className="text-sky-50 text-xl w-1/3 font-light">
                Process &<br/>Methodology
              </p>
              <p className="text-sky-100 text-md w-2/3 pb-2 pr-2 font-light">
          ...
          <img src="./NavNet-img/diagrama_navnet.webp" className="w-full" alt="Navnet" />  
        </div>  
      </div>
      ...
      <div className="flex flex-col font-display px-12 pt-10 bg-sky-50">
        <div className="flex flex-row items-center">
          <div className="flex flex-col items-center pb-8">
            ...
            <p className="text-sky-800 text-lg pb-2 px-12 font-light">
        ...
        <div className="flex flex-col items-center py-5"> 
          <div className="flex flex-row items-left pb-10 w-full">
            ...
            <div className="w-2/3">
              ...
              <div className="flex flex-col items-left p-8 bg-sky-100">
                <p className="text-sky-900 text-lg pb-2 pr-2 font-light">
                  Key insights:          
                </p>
                <p className="text-sky-900 text-md pb-2 pr-2 font-light">
                  «» It is important to unify the visual identity of the company in order to convey its image in a more consistent way.
                  <br/>
                  <br/>
                  «» NavNet’s website needs to provide detailed information about the company and its services and products to attract potential clients.<br/>
                  <br/>
          ...
          <div className="flex flex-row items-left pb-10 w-full">
            ...
            <div className="w-2/3">
              ...
              <div className="flex flex-row gap-3">
                <div className="flex flex-col items-left p-8 bg-sky-200">
                  <p className="text-sky-900 text-lg pb-2 pr-2 font-light">
                ...
                <div className="flex flex-col items-left p-8 bg-sky-900">
                  <p className="text-sky-300 text-lg pb-6 pr-2 font-light">
                  Interview recap - clients          
                  </p>
                  <p className="text-sky-300 text-md pb-2 pr-2 font-light">
